...
{
    public sealed class PrivateUserRegisterAuthCommandValidator : AbstractValidator<PrivateUserRegisterAuthCommand>
    {
        public PrivateUserRegisterAuthCommandValidator()
        {
            RuleFor(x => x.Email)
