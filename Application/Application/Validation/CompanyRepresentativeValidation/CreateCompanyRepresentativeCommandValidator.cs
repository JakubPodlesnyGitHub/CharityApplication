...
{
    public sealed class CreateCompanyRepresentativeCommandValidator : AbstractValidator<CreateCompanyRepresentativeCommand>
    {
        public CreateCompanyRepresentativeCommandValidator()
        {
