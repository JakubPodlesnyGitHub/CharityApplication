...
namespace Application.Validation.CompanyRepresentativeValidation
{
    public sealed class UpdateCompanyRepresentativeCommandValidator : AbstractValidator<UpdateCompanyRepresentativeCommand>
    {
        public UpdateCompanyRepresentativeCommandValidator()
        {
            RuleFor(x => x.IdCompanyRepresentative).NotEmpty().NotNull().WithMessage("The id of the company representative is required");
            ...
            RuleFor(x => x.RepresentativePhone)
                ...
                .MaximumLength(14).WithMessage("Phone number must not exceed 12 character long")
