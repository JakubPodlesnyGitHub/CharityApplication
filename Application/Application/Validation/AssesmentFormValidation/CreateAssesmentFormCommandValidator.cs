...
{
    public sealed class CreateAssesmentFormCommandValidator : AbstractValidator<CreateAssesmentFormCommand>
    {
        public CreateAssesmentFormCommandValidator()
        {
            RuleFor(x => x.Mail)
            ...
            RuleFor(x => x.AppRate)
                ...
                .InclusiveBetween(1, 10).WithMessage("Event App Rate is between 1 - 10");
            RuleFor(x => x.Message)
